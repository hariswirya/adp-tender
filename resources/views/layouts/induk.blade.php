  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <div class="sidebar-brand-text mx-3">ADP</div>
      </a>
      ...
      <li class="nav-item " data-toggle="tooltip" data-placement="right" title="Tampilan Ringkasan!">
        <div class="shadow-lg m-2 bg-light">
          ...
          <a class="nav-link collapsed text-dark" href="/dashboard">
      ...
      <!-- Informasi Tender - Pages Collapse Menu -->
      <li class="nav-item " data-toggle="tooltip" data-placement="right" title="Tampilan Data Tender">
        <div class="shadow-lg m-2 bg-light">
          <a class="nav-link collapsed text-dark" href="/list">
            <i class="fas fa-clone text-dark"></i>
      ...
      <li class="nav-item " data-toggle="tooltip" data-placement="right" title="Tampilan Data User">
        <div class="shadow-lg m-2 bg-light">
          <a class="nav-link collapsed text-dark" href="{{ route('user.index') }}">
      ...
      <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tampilan ringkasan grafik!">
        <div class="shadow-lg m-2 bg-light">
          <a class="nav-link text-dark" href="/grafik">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <h3 class="text-primary">Rekapitulasi RUP dan Tender</h3>
